...
<img width="1277" height="837" alt="Image" src="https://github.com/user-attachments/assets/6860d9ec-ef6d-4e19-9cac-b7e53890e6a1" />
Default theme.
...
```sh
sudo apt install ../spin-fm_2.6.14_all.deb
```
...
sudo apt install \
  ...
  udisks2 util-linux xdg-utils libglib2.0-bin adwaita-icon-theme \
...
Both launchers disable Python bytecode before project modules are imported.
...
<b> Notice, shortkeys will work when you have focus on the file manager. </b> 
...
sudo pacman -S --needed \
  ...
  udisks2 util-linux xdg-utils glib2 adwaita-icon-theme dbus
...
```sh
sudo dnf install \
  python3 python3-pyqt6 qt6-qtmultimedia python3-pyudev \
